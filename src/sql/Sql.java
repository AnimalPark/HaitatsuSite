...
public class Sql {
    ...
    public static final String YBBS_SELECTBYNO_SQL = "SELECT QANUMBER,USERID,QASUBJECT,QACOMMENT,QAGROUP,QALEVEL FROM YBBS_QA WHERE QANUMBER = ?";
    ...
    public static final String YBBS_DELETE_SQL = "DELETE FROM YBBS_QA WHERE QAGROUP = ?";
    public static final String YBBS_DELETE_REPLY_SQL = "DELETE FROM YBBS_QA WHERE QANUMBER = ?";
	...
	public static final String RESTAURANT_INSERT_RESTAURANT_SQL = "INSERT INTO restaurant values(seq_restaurant.nextval, ?,?,?,?,0.0,?,?)";
