...
<body>
	<form action="admin_rtrt_insert">
		<h2>메뉴 등록</h2>
		<hr>
		메뉴 이름<input type="text" name="rName"
			placeholder="가게명을 입력하세요"><br /> <input
			type="text" name="rPhoneNum" placeholder="대표전화번호를 입력하세요"><br />
		Category number <select name="cNum">
			<option>-------업종선택-------</option>
		...
		</select><br /> Town number <select name="townNum">
			<option>-------지역선택-------</option>
		...
		</select><br /> Star average <select name="starAvg">
			<option>-------별점-------</option>
		...
		</select><br /> Address<input type="text" name="rAddr" placeholder="이름을입력하세요"><br />
