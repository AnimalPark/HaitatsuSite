...
<body>
	...
	<div class="info-form">
		<form method="post" action="">
			<h3>회원정보</h3>
			<br />
			<div class="form-group">아이디 : ${users.userId}</div>
			<div class="form-group">이름 : ${users.uName}</div>
			<div class="form-group">주소 : ${users.uAddr}</div>
			<div class="form-group">연락처 : ${users.uPhonenum}</div>
			<br /> <br /> <br />
			<div class="text-center">
				<a href="updateInfo_link">회원정보 수정</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
					href="updateuPwd_link">비밀번호 변경</a>
			</div>
		</form>
	</div>
	<br /><br /><br />
