...
a:hover {
	text-d "WebContent/board/qaboardReply.jsp"ecoration: underline;
	color: red;
}
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1 m-auto">
				<div class="contact-form">
					...
					<form action="ybbs_reply.ad" method="post" style="display: inline">
						<input type="hidden" name="userId" id="userId"
							value="${users.userId}"> <input type="hidden"
							name="qaGroup" id="qaGroup" value="${num}" />
						<div class="row">
							<div class="col-sm-4">
						...
						<button type="submit" class="btn btn-primary"
							style="margin: 4px; min-width: 50px;">답글 작성</button>
					</form>
