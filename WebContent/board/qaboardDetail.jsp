    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1 m-auto">
            <div class="contact-form">
					...
					<a href="ybbs_delete?qagroup=${ybbs.qagroup}" onclick="return delchk();"><button class="btn btn-primary" style="margin:4px">글 삭제하기</button></a>	
...
<c:if test="${ybbs.userid != users.userId && ybbs_id != users.userId && users.authority != 1}">
			<div class="form-group">
                <textarea class="form-control" rows="10" style="width:100%; text-align:center;" readonly>글 작성자만 읽을 수 있습니다</textarea>
            </div>
			<a href = "ybbs_req_list?reqPage=1"><button class="btn btn-primary" style="margin:4px; text-align:center;">목록으로</button></a>
		</c:if>
