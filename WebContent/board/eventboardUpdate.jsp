    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1 m-auto">
            <div class="contact-form">
                ...
                <form action="ybbs_event_update.ad" method="post" style="display:inline;">
                    <input type="hidden"  name="evNumber" value="${ybbs.evNumber}"/>
                    <div class="row">
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputSubject" name="evSubject" value="${ybbs.evSubject}" required>
                    </div>
                    <div class="form-group">
                        <label for="inputMessage">내용</label>
                        <textarea class="form-control" id="inputMessage" name="evComment" rows="10" style="width:100%" required>${ybbs.evComment}</textarea>
                    </div>
                    <button type="submit" class="btn btn-primary" style="margin:4px">글 수정</button>
                </form>
     				<a href="ybbs_eventDetail.do?evNumber=${ybbs.evNumber}"><button class="btn btn-primary" style="margin:4px">수정 취소</button></a>
            </div>
        </div>
    </div>
</div>
