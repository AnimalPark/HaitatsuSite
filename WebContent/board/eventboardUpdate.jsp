...
a:hover {
	text-d "WebContent/board/eventboardUpdate.jsp"ecoration: underline;
	color: red;
}
					...
					<form action="ybbs_event_update.ad" method="post"
						...
						<div class="form-group">
							<label for="inputSubject">제목</label> <input type="text"
								...
								value="${ybbs.evSubject}" required>
						</div>
						<div class="form-group">
							<label for="inputMessage">내용</label>
							<textarea class="form-control" id="inputMessage" name="evComment"
								rows="10" style="width: 100%" required>${ybbs.evComment}</textarea>
						</div>
						<button type="submit" class="btn btn-primary"
							style="margin: 4px; min-width: 50px;">글 수정</button>
					</form>
					<a href="ybbs_eventDetail.do?evNumber=${ybbs.evNumber}"><button
